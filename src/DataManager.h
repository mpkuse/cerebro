...
public:
    ...
    void raw_image_callback( const sensor_msgs::ImageConstPtr& msg );   atomic<bool> m_raw_image_callback; bool is_raw_image_callback() { return m_raw_image_callback; }
    void raw_image_callback_1( const sensor_msgs::ImageConstPtr& msg ); atomic<bool> m_raw_image_callback_1;  bool is_raw_image_callback_1() { return m_raw_image_callback_1; }
    void depth_image_callback( const sensor_msgs::ImageConstPtr& msg ); atomic<bool> m_depth_image_callback;  bool is_depth_image_callback() { return m_depth_image_callback; }
