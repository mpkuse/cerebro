...
public:
    ...
    const int loop_hypothesis_i_idx( int i, int& seq_a_start, int& seq_a_end, int& seq_b_start, int& seq_b_end ) const;
    const int loop_hypothesis_i_T(   int i, ros::Time& seq_a_start_T, ros::Time& seq_a_end_T, ros::Time& seq_b_start_T, ros::Time& seq_b_end_T  ) const;
    const int loop_hypothesis_i_im(  int i, cv::Mat& seq_a_start_im , cv::Mat& seq_a_end_im , cv::Mat& seq_b_start_im , cv::Mat& seq_b_end_im ) const;
    json loop_hypothesis_as_json() const;

private:
    // HypothesisManager * hyp_manager; TODO shared_ptr
    std::shared_ptr<HypothesisManager> hyp_manager;
